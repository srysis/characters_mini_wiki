import Pandemonica_image from "../files/Pandemonica.gif"

function PandemonicaPage() {
	return(
		<main>
			...
			<section>
				...
				<p>
					...
					if something is done wrong. So this quality can be considered as a bad one, 
					although it's not as revealing as, for example, Modeus's "<em>lusty</em>" nature.
				</p>
			</section>
			<section>
				<h2>Appearance</h2>
...
export default PandemonicaPage;